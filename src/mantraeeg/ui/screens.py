...
class ExplainScreen(Screen):
    ...
    def __init__(self, cfg: Config) -> None:
        ...
        # O aviso de calibracao curta NAO vive aqui. E linguagem de
        # investigador — "6 janelas de referencia" — a frente de quem veio
        # meditar, e o ecra de explicacao e para preparar a pessoa, nao para
        # a preocupar com estatistica. Fica no painel do CTRL+I, que e de
        # quem toma a decisao.
